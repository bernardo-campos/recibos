...
@section('content_header')
    <h1 class="m-0 text-dark">Nuevo recibo</h1>
@stop

@section('content')

 <form class="form-horizontal" onsubmit="return confirm('Se creará el nuevo recibo. ¿Continuar?')" action="{{ route('receipts.store') }}" method="POST">
    @csrf
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <x-adminlte-select
                    ...
                    label="Forma de pago"
                    fgroup-class="col-lg-2">
                    <option value="1" @if(old('type') == "1") selected="" @endif>Efectivo</option>
                    <option value="2" @if(old('type') == "2") selected="" @endif>Cheque</option>
                    <option value="3" @if(old('type') == "3") selected="" @endif>Depósito</option>
                    <option value="4" @if(old('type') == "4") selected="" @endif>Transferencia</option>
                    <option value="5" @if(old('type') == "5") selected="" @endif>Otro</option>
                </x-adminlte-select>
